...
const Login = () => {
    return (
        <div>
            ...
            <section className="text-gray-600 xl:max-w-[1300px] w-full container px-5 py-24 mx-auto flex flex-wrap items-center justify-center">                <div className="text-center lg:mb-4 mb-1">
